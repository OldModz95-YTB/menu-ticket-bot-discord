...
const config = require("./config.json"); //Import config such as token/prefix/channel id/ message defaut/category
...
client.on("messageCreate", async (message) => {
    ...
    if(cmd == "setup") {
        ...
        let TicketEmbed = new Discord.MessageEmbed()
            ...
            .setFooter(`Proposed By ProtonDev - ${message.guild.name}`, message.guild.iconURL({dynamic: true}));
            ...
            .addOptions([ //maximum 25 items
                {
                    ...
                    description: "General Support".substr(0, 50), //maximum 50 Letters long
                    emoji: "👌", //optional
                },
                {
                    label: "Question".substr(0, 25), //maximum 25 Letters long
                    value: "question".substr(0, 25), //maximum 25 Letters long
                    description: "Question random".substr(0, 50), //maximum 50 Letters long
                    emoji: "👍", //optional
                }
            ])
